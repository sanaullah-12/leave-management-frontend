...
const ImportTemplateModal: React.FC<Props> = ({ open, onClose, onImport }) => {
  ...
  return (
    ...
    >
      {/* Mode switch */}
      <div className="mb-4 flex gap-1 rounded-full bg-gray-100 p-1 dark:bg-gray-700/50">
        {[
          ...
          return (
            <button
              ...
              className={`relative flex flex-1 items-center justify-center gap-1.5 rounded-full px-2 py-1.5 text-sm font-medium transition-colors ${
                active
