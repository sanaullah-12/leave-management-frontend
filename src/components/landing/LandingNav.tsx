...
const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative grid h-9 w-9 shrink-0 place-items-center overflow-hidden rounded-full text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-white/5"
